        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">achievementtypes</h4>
                    <a href="{{route('achievementtypes.create')}}"> <button type="button"
                                class="btn btn-outline-primary mr-1 mb-1 waves-effect waves-light"><i
                               class="feather icon-user"></i> Add New
                            achievementtype</button></a>
                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table zero-configuration dataTable"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row"
                                                    ...
                                                    <td class="sorting_1">{{ $achievementtype->name }}</td>

                                                    <td>
                                                        <a href="{{   route('achievementtypes.edit',$achievementtype->id) }}"
                                                            class="btn btn-xs btn-info"> <i
                                                               class="feather icon-edit font-medium-5"></i> </a>
                                                        <a id="progress-bar" href="javascript:;"
                                                           data-toggle="modal"
                                                           onclick="deleteData({{$achievementtype->id}})"
                                        ...
                                        <script type="text/javascript">
                                            function deleteData(id)
                                                    {
                                                        var id = id;
                                                        var url = '{{ route("achievementtypes.destroy", ":id") }}';
