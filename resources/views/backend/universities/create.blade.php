        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ trans('backend.new_university') }}</h4>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label for="Univercity-Languages">Univercity Languages</label>
                                                            <div class="form-group">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label for="University-Departments">University Departments</label>
                                                            <div class="form-group">
                                                                <select  multiple class="select2 form-control select2-hidden-accessible"
                                                                       name="departments[]"
                                                                        required
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label for="branch-city">University City</label>
                                                            <div class="form-group">
                                                                <select class="select2 form-control select2-hidden-accessible"
                                                                        name="city_id"
                                                                        required
                                                ...
                                                <div class="tab-content pt-1">
                                                    <div class="tab-pane active"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label for="university.contact_details">{{ trans('backend.contact_details') }}</label>
                                                                    <div class="form-group">
                                                                        <textarea data-length="2000"
                                                                                  class="form-control char-textarea"
                                                                                  rows="3"
