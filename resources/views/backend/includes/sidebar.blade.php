            ...
            <li class=" nav-item"><a href="index.htm"><i class="feather icon-home"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="nav-link"
                           ...
                           <li><a class="nav-link"
                                   href="{{ route('news.index') }}">Manage News</a></li>
                            <li><a class="nav-link"
                                   href="{{ route('posts.index') }}">Manage Posts</a></li>
                ...
                <ul class="menu-content">
                    <li><a href="{{asset('backend/starter-kit/rtl/vertical-menu-template/sk-layout-2-columns.html')}}"><i
                               class="feather icon-circle"></i><span class="menu-item"
                                  data-i18n="2 columns">2
                                columns</span></a>
                    </li>
                    <li><a
                           href="{{asset('backend/starter-kit/rtl/vertical-menu-template/sk-layout-fixed-navbar.html')}}"><i
                               class="feather icon-circle"></i><span class="menu-item"
                                  data-i18n="Fixed navbar">Fixed
                                navbar</span></a>
                    </li>
                    <li><a
                           href="{{asset('backend/starter-kit/rtl/vertical-menu-template/sk-layout-floating-navbar.html')}}"><i
                               class="feather icon-circle"></i><span class="menu-item"
