        ...
        <div class="navbar-container content">
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="flag-icon flag-icon-{{app()->getLocale()}}"></i><span class="selected-language">{{app()->getLocale()}}</span></a>
                    ...
                    <a class="dropdown-item" href="{{ '/lang/'.$lang }}" data-language="{{$lang}}"><i class="flag-icon flag-icon-{{$lang}}"></i> {{$lang}}</a>
                        @endif
                        @endforeach
                    </div>
                    </li>
                            ...
                            <li class="scrollable-container media-list"><a class="cart-item"
                                    ...
                                    <div class="media">
                                        <div class="media-left d-flex justify-content-center align-items-center"><img
                                                src="{{asset('backend/app-assets/images/pages/eCommerce/4.png') }}"
                                    ...
                                    <div class="media">
                                        <div class="media-left d-flex justify-content-center align-items-center"><img
                                                src="{{asset('backend/app-assets/images/pages/eCommerce/10.png') }}"
                                                width="75" alt="Cart Item"></div>
                                        <div class="media-body"><span
