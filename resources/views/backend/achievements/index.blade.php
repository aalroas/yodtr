                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc"
                                                        ...
                                                        colspan="1"
                                                        aria-sort="ascending"
                                                        aria-label="student_name: activate to sort column descending"
                                                        style="width: 50px;">student Name</th>
                                                    <th class="sorting_asc"
                                                        tabindex="0"
                                                        aria-controls="DataTables_Table_0"
                                                        rowspan="1"
                                                        ...
                                                        <th class="sorting_asc"
                                                            ...
                                                            colspan="1"
                                                            aria-sort="ascending"
                                                            aria-label="achievementtypes: activate to sort column descending"
                                                            style="width: 200px;">achievement types </th>
                                                    ...
                                                    <th class="sorting_asc"
                                                        ...
                                                        style="width: 10px;">show_in_home</th>
                                                        <th class="sorting_asc"
                                                            tabindex="0"
                                                            aria-controls="DataTables_Table_0"
                                                            rowspan="1"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row"
                                                    ...
                                                    <td> <img style="height: 50px;width: 50px;"
                                                             class="img-circle"
                                                             src="{{ asset('uploads/achievements/images/')}}/{{$achievement->image }}">
                                                    </td>

                                                    <td class="sorting_1">{{ $achievement->student_name }}</td>
                                                    ...
                                                    <i class="feather icon-award" style="color:red"></i> {{ $type->name}}<br>
                                                    ...
                                                    <td class="sorting_1">{{ $achievement->branch->name }}</td>



                                                    <td class="sorting_1"> @if ( $achievement->show_in_home == 1)
                                                        yes
                                                        @else
                                                        no
                                                        @endif
                                                    ...
                                                    <td class="sorting_1"> @if ( $achievement->status == 1)
                                                        yes
                                                        @else
                                                        no
                                                        @endif
                                                    ...
                                                    <td class="sorting_1">
                                                        ...
                                                        <a id="progress-bar"
                                                           href="javascript:;"
                                                           data-toggle="modal"
                                                           onclick="deleteData({{$achievement->id}})"
