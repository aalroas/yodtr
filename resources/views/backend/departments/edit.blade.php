        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ trans('backend.edit_department') }}</h4>
                         ...
                         {{ method_field('PATCH') }}
                                                ...
                                                <div class="tab-content pt-1">
                                                    <div class="tab-pane active"
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               name="name_ar" value="{{ $department->name_ar }}"
                                                               aria-required="true"
                                                    ...
                                                    <div class="tab-pane"
                                                        ...
                                                        <input type="text"
                                                               class="form-control"
                                                               required
                                                               name="name_en"  value="{{ $department->name_en }}"
                                                               aria-required="true"
                                                               minlength="2">
                                                    </div>
                                                    ...
                                                    <div class="tab-pane"
                                                        ...
                                                        <input type="text"
                                                               class="form-control"
                                                               required
                                                               name="name_tr"  value="{{ $department->name_tr }}"
                                                               aria-required="true"
                                                               minlength="2">
                                                    </div>
                            ...
                            <div class="box-footer">
                                ...
                                <a type="button"
                                   ...
                                   href="{{   route('departments.index')   }}">{{ trans('backend.back') }}</a>
                            </div>
                        </form>
