        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ trans('backend.new_slider') }}</h4>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label for="branch-city">Slider Branch</label>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <textarea data-length="2000"
                                                                                  ...
                                                                                  name="text_ar"
                                                                                  required
                                                                                  placeholder="{{ trans('backend.text') }}">{{old('text_ar')}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <textarea data-length="2000"
                                                                                  ...
                                                                                  name="text_en"
                                                                                  required
                                                                                  placeholder="{{ trans('backend.text') }}">{{old('text_en')}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <textarea data-length="2000"
                                                                                  ...
                                                                                  name="text_tr"
                                                                                  required
                                                                                  placeholder="{{ trans('backend.text') }}">{{old('text_tr')}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
