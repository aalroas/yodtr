        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('sliders.create')}}"> <button type="button"
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row"
                                                    ...
                                                    <td> <img style="height: 50px;width: 50px;"
                                                             class="img-circle"
                                                             src="{{ asset('uploads/sliders/images/')}}/{{$slider->image }}">
                                                    </td>
                                                    ...
                                                    <td class="sorting_1">{{ $slider->branch->name }}</td>



                                                    <td class="sorting_1"> @if ( $slider->show_in_home == 1)
                                                        yes
                                                        @else
                                                        no
                                                        @endif
                                                    ...
                                                    <td class="sorting_1"> @if ( $slider->status == 1)
                                                        yes
                                                        @else
                                                        no
                                                        @endif
