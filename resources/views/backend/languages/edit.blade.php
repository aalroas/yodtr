        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ trans('backend.edit_language') }}</h4>
                         ...
                         {{ method_field('PATCH') }}
                                                ...
                                                <div class="tab-content pt-1">
                                                    <div class="tab-pane active"
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               name="name_ar" value="{{ $language->name_ar }}"
                                                               aria-required="true"
                                                    ...
                                                    <div class="tab-pane"
                                                        ...
                                                        <input type="text"
                                                               class="form-control"
                                                               required
                                                               name="name_en"  value="{{ $language->name_en }}"
                                                               aria-required="true"
                                                               minlength="2">
                                                    </div>
                                                    ...
                                                    <div class="tab-pane"
                                                        ...
                                                        <input type="text"
                                                               class="form-control"
                                                               required
                                                               name="name_tr"  value="{{ $language->name_tr }}"
                                                               aria-required="true"
                                                               minlength="2">
                                                    </div>
                            ...
                            <div class="box-footer">
                                ...
                                <a type="button"
                                   ...
                                   href="{{   route('languages.index')   }}">{{ trans('backend.back') }}</a>
                            </div>
                        </form>
