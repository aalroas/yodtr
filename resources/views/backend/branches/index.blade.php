        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{route('branches.create')}}"> <button type="button"
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc"
                                                        ...
                                                        <th class="sorting_asc"
                                                            ...
                                                            colspan="1"
                                                            aria-sort="ascending"
                                                            aria-label="sub-domain: activate to sort column descending"
                                                            style="width: 271px;">sub-domain</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row"
                                                    ...
                                                    <td> <img style="height: 50px;width: 50px;"
                                                             class="img-circle"
                                                             src="{{ asset('uploads/branches/logo/')}}/{{$branch->logo }}"></td>

                                                    <td class="sorting_1">{{ $branch->name }}</td>


                                                    <td class="sorting_1">{{ $branch->branch_subdomain }}</td>

                                                    <td class="sorting_1">{{ $branch->city->name }}</td>



                                                    <td class="sorting_1">
                                                        <a href="{{   route('branches.edit',$branch->id) }}"
                                                           class="btn btn-xs btn-success font-small"> <i class="feather icon-eye font-medium-5"></i> </a>
