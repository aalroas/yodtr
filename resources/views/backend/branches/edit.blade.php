                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="file"
                                                                        ...
                                                                        data-default-file="{{ asset('uploads/branches/logo/')}}/{{$branch->logo }}"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label class="text-bold-600 font-medium-2 mb-1"
                                                                   for="account-e-mail"> branch sub-domain</label>
                                                            <div class="input-group">
                                                                <input type="text"
                                                                       class="form-control"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label for="branch-branch">Branch City</label>
                                                            <div class="form-group">
                                                    ...
                                                    <div class="tab-pane active"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <label
                                                                           for="branch-description">{{ trans('backend.description') }}</label>
                                                                    <div class="form-group">
                                                                        <textarea data-length="2000"
                                                                                  ...
                                                                                  name="description_ar"
                                                                                  required
                                                                                  placeholder="{{ trans('backend.description') }}">{{ $branch->description_ar}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <textarea data-length="2000"
                                                                                  ...
                                                                                  required
                                                                                  placeholder="{{ trans('backend.description') }}">{{ $branch->description_en}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <textarea data-length="2000"
                                                                                  ...
                                                                                  name="description_tr"
                                                                                  required
                                                                                  placeholder="{{ trans('backend.description') }}">{{ $branch->description_tr}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
